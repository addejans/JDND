...
public class CarService {
    ...
    public CarService(CarRepository repository, PriceClient priceClient, MapsClient mapsClient) {
        /**
         * Add the Maps and Pricing Web Clients created
    ...
    public Car findById(Long id) {
        ...
        /**
         * Use the Pricing Web client created in `VehiclesApiApplication`
        ...
        /**
         * Use the Maps Web client created in `VehiclesApiApplication`
         *   to get the address for the vehicle. We should access the location
